...
void LoggerModule::initWeedPressure(void )
{
...
void LoggerModule::initRuntime(void )
{
...
void LoggerModule::initWeedAmount(void )
{
...
void LoggerModule::runtimeLogger(qint64 ExcessGreenTime, qint64 thresholdtime, qint64 morphtime,
...
void LoggerModule::pngImageLogger(cv::Mat image)
{
...
void LoggerModule::rawImageLogger(void* img)
{
...
void LoggerModule::initGPS(void )
{
...
void LoggerModule::NMEALogger(QByteArray talker, QByteArray command, QList< QByteArray > arg)
{
...
void LoggerModule::GGALogger(QByteArray time, QByteArray latitude, char latitudeHeading,
